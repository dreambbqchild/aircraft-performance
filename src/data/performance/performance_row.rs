...
impl PerformanceRow {
    fn new(wind_speed: Option<i16>, lower_bound: Distance, middle_value: Distance, upper_bound: Distance) -> Self {
        PerformanceRow {
            wind_speed,
            lower_bound,
            middle_value,
    ...
    pub fn new_labeled(wind_speed: i16, lower_bound: Distance, middle_value: Distance, upper_bound: Distance) -> Self {
